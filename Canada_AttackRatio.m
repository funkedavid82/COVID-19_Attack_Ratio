...
p =1-(0.035*0.57 + 0.8549*0.80); %new vaccination coverage for Canada as of Nov. 20, 2021
...
% Calculation of baseline beta1star for original strain
R = 2.5;
c11= 11.27; %adult-adult contact rate in Canada

beta1_0 = (R*gamma1_0/c11); %baseline beta_1star in the manuscript
...
N1 = 33198268;
N2 = 4806970;
S10=(1-(0.035*0.57 + 0.8549*0.80))*N1; %susceptible with the new vaccination coverage for Canada as of Nov. 20, 2021
S20=N2;
E10=100;
E20=10;
I10=100;
I20=10;
c11 = 11.27; % (Adult contact adult),
c12 = 0.99; % (Adult contact kids),
c21 = 6.85; % (Kids contact adults),
c22 = 4.47; % (Kids contact kids).
...
beta1_delta = beta1_0*1.4*1.6; %beta1_star for the delta variant in Canada 
...
% definition of the baseline removal rates
...
gamma2_vector = 1./[0:0.1:10];
c22 = 4.47; % (kids contact kids) Canada;
beta1_delta = beta1_0*1.4*1.6;
beta2_delta_vector = [0.7*beta1_delta, 0.6*beta1_delta, 0.5*beta1_delta, 0.4*beta1_delta]; %beta2_delta=40-70% of beta1_delta 
